...
class InvestmentPie extends React.Component {
  ...
  render() {
    ...
    let value = this.state.value
      ? "$" + this.state.value.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, "$&,")
      ...
      button = (
        <div className="crud-button-container">
          <button
            ...
            onClick={() => this.props.openModal("createPortfolio")}
          >
            Create Portfolio
          </button>
          <button
            className="crud-delete-button"
            onClick={() => this.props.openModal("deletePortfolio")}
          >
            Remove Portfolio
          </button>
        </div>
    ...
    if (this.props.match.params.portfolioId) {
      button = (
        <div className="crud-button-container">
          <button
            className="crud-create-button"
            onClick={() => this.props.openModal("createPie")}
          >
            Create Pie
          </button>
          <button
            className="crud-delete-button"
            onClick={() => this.props.openModal("deletePie")}
          >
            Delete Pie
          </button>
        </div>
    ...
    if (this.props.match.params.pieId) {
      button = (
        <div className="crud-button-container">
          <button
            className="crud-create-button"
            onClick={() => this.props.openModal("buyStock")}
          >
            Buy Stock
          </button>
          <button
            className="crud-delete-button"
            onClick={() => this.props.openModal("rebalance")}
          >
            Rebalance
          </button>
          <button
            className="crud-delete-button"
            onClick={() => this.props.openModal("sellStock")}
          >
            Sell Stock
          </button>
        </div>
