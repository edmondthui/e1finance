...
class PortfolioShowIndex extends React.Component {
  ...
  componentDidMount() {
    let paramsId = this.props.match.params.portfolioId
    ...
    let items = this.props.items.map((item) => (
      ...
      >
        <div className="portfolio-name">
          <img
            src="https://i.postimg.cc/ncKSVm8J/pie-image.png"
            alt="pie-image"
            height="40"
            width="40"
          />
          <p>{item.pie_name ? item.pie_name : window.location.reload()}</p>
        </div>
          ...
          <div className="portfolio-index-container">
            ...
            {items.length > 0 ? (
              ...
              <div className="portfolio-index-item">
                <div className="portfolio-name">
                  <p>Please create a portfolio or pie to buy / sell stocks.</p>
                </div>
              </div>
            )}
          </div>
