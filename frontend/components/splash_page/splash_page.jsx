        ...
        <main>
            ...
            <div className="why-e1" id="why-e1">
                ...
                <div className="why-e1-container">
                    ...
                    <img src="https://i.postimg.cc/RVNnNgsH/goals-5b-1-768x768.png" alt="" height="30%" width="30%"/>
                </div>
                <div className="why-e1-container">
                    <img src="https://i.postimg.cc/pX458K41/race-2-768x587.png" alt="" height="30%" width="30%"/>
                    <div className="why-e1-text">
                ...
                <div className="why-e1-container">
                    ...
                    <img src="https://i.postimg.cc/JhWyYM1N/low-cost-768x768.png" alt="" height="30%" width="30%" />
                </div>
                <div className="why-e1-container">
                    <img src="https://i.postimg.cc/c1DnxpmW/consistency-1-768x768.png" alt="" height="30%" width="30%"/>
                    <div className="why-e1-text">
