  ...
  render() {
    ...
    const form = (
      <form className={`${formName}-form`}>
        ...
        {this.props.formType === "Log In" ? (<p className="change-form">Don't have an account? <Link to="/signup">Sign up</Link></p>) : (<p className="change-form">Already have an account? <Link to="/login">Login</Link></p>)}
      </form>
    );
          ...
          <div className="signup-content">
            <div className="signup-form-text">
              <h1 fontSize="36px" fontWeight="600">
                Say goodbye to fees and hello to your perfect investment account
              </h1>
              <ul>
    ...
    return <div className="form-container">{formType}</div>;
  }
}
