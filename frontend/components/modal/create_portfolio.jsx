          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="create-portfolio-radio">
              ...
              <div>
                ...
                <p>
                  Open a taxable joint brokerage account. Please note that we
                  will ask for the personal information for both people on the
                  account.
                </p>
              </div>
            </div>
            <div className="create-portfolio-radio">
              ...
              <div>
                ...
                <p>
                  Open a Traditional, Roth or SEP IRA or rollover an existing
                  401(k)
                </p>
              </div>
            </div>
