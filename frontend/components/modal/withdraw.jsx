...
class Withdraw extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.createActivity({activity: "", name: "Withdraw", value: this.state.buying_power, user_id: this.props.user.id})
                    ...
                    <form onSubmit={this.handleSubmit} className="buy-form">
                        <div className="deposit-form-items">
                            ...
                            <div className="input-value-number-container">
                                ...
                                <input type="number" className="input-value-buy"  step=".01" value={this.state.value} onChange={this.update("buying_power")} placeholder="0"/>
                            </div>
                        </div>
                        <input type="submit" value="Withdraw" className="create-portfolio-submit"/>
                    </form>
                </div>
            </div>
        )
